    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
				...
				<li>
					<a href="./signup"><i class="fa fa-user fa-fw"></i> Driver Sign Up</a>
				</li>
				<li>
					<a href="./agent-login"><i class="fa fa-user fa-fw"></i> LVI Agent Login</a>
				</li>
				<li>
					<a href="./driver-login"><i class="fa fa-user fa-fw"></i> Driver Login</a>
				</li>
				<li>
